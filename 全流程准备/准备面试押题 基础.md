...
事件监听 DOM 操作（如点击与滚动） 、用户页面输入、发起一个网络请求、读取文件，与程序产生交互的这些都可以叫作 I/O    
...
// 顺序：同步宏 => 异步微1 => 异步微1 => 异步微1 里的异步微 => 异步宏1 => 异步宏1 里的异步微 => 异步宏2 => 异步微1 里的异步宏 => 异步宏1 里的异步宏
// async1 start
// async2
// start
// async1 end
...
![执行顺序.svg](https://cdn.nlark.com/yuque/0/2024/svg/1614731/1707927884245-b2f2aed2-a028-45d7-8e96-5d34fae163c9.svg)
